...
Spearman ρ = **+0.357** (p = 0.3851)

Sensitivity — collapsing repeated rule feature-sets to one vote each (so `{MedInc}` counts once however many anchors use it): ρ = **+0.333** (p = 0.4198). A large gap between the two would mean the ranking is driven by how OFTEN a feature is used rather than how much it matters when used.

| Class | Distinct feature-sets | Median pairwise Jaccard | Max Jaccard | Pairs J>0.5 |
|---|---:|---:|---:|---:|
| class_0 | 13 | 0.000 | 0.619 | 0.4% |
| class_1 | 15 | 0.000 | 0.577 | 0.1% |
| class_2 | 11 | 0.145 | 0.902 | 11.1% |
| class_3 | 24 | 0.000 | 0.800 | 2.0% |
...
|---|---:|---:|---:|---:|
| Latitude | 8.6% | 35.7% | 4 | 1 |
| Longitude | 35.8% | 32.7% | 1 | 2 |
| MedInc | 12.0% | 13.3% | 3 | 3 |
| AveOccup | 6.0% | 7.9% | 7 | 4 |
| AveRooms | 2.6% | 5.4% | 8 | 5 |
| HouseAge | 21.1% | 2.9% | 2 | 6 |
| AveBedrms | 6.6% | 1.1% | 6 | 7 |
| Population | 7.4% | 0.9% | 5 | 8 |

## Per-class agreement

| Class | ρ | Anchor top-3 | EBM top-3 | Anchor boxes | Mean rule precision | Mean coverage |
|---|---:|---|---|---:|---:|---:|
| very_low_price | +0.52 | Longitude, HouseAge, AveOccup | Latitude, Longitude, MedInc | 60 | 0.429 | 0.0340 |
| low_price | +0.40 | MedInc, Longitude, HouseAge | Longitude, Latitude, MedInc | 60 | 0.513 | 0.0140 |
| medium_price | +0.52 | Longitude, AveRooms, MedInc | Latitude, Longitude, MedInc | 60 | 0.269 | 0.2956 |
| high_price | -0.29 | HouseAge, AveBedrms, Latitude | Latitude, Longitude, MedInc | 60 | 0.245 | 0.0815 |
