...
- `class_1` (k=1)
  1. random box 134  — Fid —, Cov 0.000, n=0
- `class_2` (k=1)
  1. random box 181  — Fid —, Cov 0.000, n=0
...
- `class_0` (k=1)
  1. random box 125  — Fid —, Cov 0.000, n=0
- `class_1` (k=1)
  1. random box 134  — Fid —, Cov 0.000, n=0
- `class_2` (k=1)
  1. random box 181  — Fid —, Cov 0.000, n=0
...
- `class_0` (k=1)
  1. random box 131  — Fid —, Cov 0.000, n=0
- `class_1` (k=1)
...
- `class_0` (k=1)
  1. random box 187  — Fid —, Cov 0.000, n=0
- `class_1` (k=1)
...
- `class_0` (k=1)
  1. random box 105  — Fid —, Cov 0.000, n=0
- `class_1` (k=1)
  1. random box 0  — Fid —, Cov 0.000, n=0
...
- `class_0` (k=1)
  1. random box 147  — Fid —, Cov 0.000, n=0
- `class_1` (k=1)
  1. random box 154  — Fid —, Cov 0.000, n=0
